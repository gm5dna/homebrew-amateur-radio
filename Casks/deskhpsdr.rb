cask "deskhpsdr" do
  ...
  on_arm do
    sha256 "625a360a77a34741b340d4b510f3998807a158f7c778bea140bda6dc4fe3354c"

    url "https://github.com/dl1bz/deskhpsdr/releases/download/#{version}/deskHPSDR-#{version}-master-1bd9e89-macos-arm64.zip"
  end
  on_intel do
